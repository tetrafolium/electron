...
void BrowserContext::InitPrefs() {
  ...
  prefs_factory.SetUserPrefsFile(
      prefs_path, JsonPrefStore::GetTaskRunnerForFile(
...
net::URLRequestContextGetter* BrowserContext::CreateRequestContext(
  ...
  url_request_getter_ = new URLRequestContextGetter(
      this, network_controller_handle(),
      static_cast<NetLog*>(BrowserClient::Get()->GetNetLog()), GetPath(),
