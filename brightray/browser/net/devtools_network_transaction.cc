...
int DevToolsNetworkTransaction::RestartWithAuth(
  ...
  int result = transaction_->RestartWithAuth(
...
void DevToolsNetworkTransaction::SetQuicServerInfo(net::QuicServerInfo* info) {
