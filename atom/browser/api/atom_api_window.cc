...
Window::Window(v8::Isolate* isolate,
...
void Window::Init(v8::Isolate* isolate,
  ...
  window_.reset(
      NativeWindow::Create(web_contents->managed_web_contents(), options,
...
#if defined(OS_WIN)
bool Window::HookWindowMessage(UINT message, const MessageCallback& callback) {
...
v8::Local<v8::Value> Window::GetNativeWindowHandle() {
  ...
  return ToBuffer(isolate(), static_cast<void*>(&handle),
...
void Window::BuildPrototype(v8::Isolate* isolate,
  ...
  mate::ObjectTemplateBuilder(isolate, prototype->PrototypeTemplate())
      ...
      .SetMethod("isVisibleOnAllWorkspaces", &Window::IsVisibleOnAllWorkspaces)
