...
void NativeWindow::DidFirstVisuallyNonEmptyPaint() {
  ...
  base::ThreadTaskRunnerHandle::Get()->PostTask(
      FROM_HERE, base::Bind(&NativeWindow::NotifyReadyToShow, GetWeakPtr()));
}
...
void NativeWindow::ScheduleUnresponsiveEvent(int ms) {
  ...
  window_unresposive_closure_.Reset(base::Bind(
      &NativeWindow::NotifyWindowUnresponsive, weak_factory_.GetWeakPtr()));
  base::ThreadTaskRunnerHandle::Get()->PostDelayedTask(
      FROM_HERE, window_unresposive_closure_.callback(),
