...
(t = x(o)), (function(e, undefined) {
  ...
  function ot(e, t, r, i) {
    ...
    if (((t ? t.ownerDocument || t : b) !== p && c(t), (t = t || p),
        ...
        if ((a = o[1])) {
          if (9 === u) {
            ...
            if (s.id === a)
              ...
              t.ownerDocument && (s = t.ownerDocument.getElementById(a)) &&
              y(t, s) && s.id === a)
            return r.push(s), r;
        } else {
          if (o[2])
  ...
  (s = ot.isXML =
      ...
      (c = ot.setDocument =
           function(e) {
             ...
             return t !== p && 9 === t.nodeType && t.documentElement ?
                 ((p = t), (f = t.documentElement), (h = !s(t)),
                  r && r.attachEvent && r !== r.top &&
                      r.attachEvent(
                          'onbeforeunload',
                          function() {
                            c();
                  ...
                  (n.matchesSelector = Q.test(
                       (m = f.webkitMatchesSelector || f.mozMatchesSelector ||
                  ...
                  (S = f.compareDocumentPosition ?
                       ...
                       function(e, n) {
                         var r, i = 0, o = e.parentNode, s = n.parentNode,
                                a = [e], u = [n];
                         if (e === n)
                           return (E = !0), 0;
                         if (!o || !s)
      ...
      (ot.matchesSelector =
           function(e, t) {
             if (((e.ownerDocument || e) !== p && c(e),
                  (t = t.replace(Y, '=\'$1\']')),
                  !(!n.matchesSelector || !h || (g && g.test(t)) ||
                    (d && d.test(t)))))
               try {
                 var r = m.call(e, t);
      ...
      (i = ot.selectors = {
        ...
        pseudos: {
          ...
          focus: function(e) {
            return (
                e === p.activeElement && (!p.hasFocus || p.hasFocus()) &&
          ...
          text: function(e) {
            var t;
            return (
                'input' === e.nodeName.toLowerCase() && 'text' === e.type &&
        ...
        if (((n = i.filter[e[l].type].apply(null, e[l].matches)), n[v])) {
          for (r = ++l; o > r; r++)
            if (i.relative[e[r].type])
              break;
          return bt(
              l > 1 && vt(f), l > 1 && mt(e.slice(0, l - 1).concat({
                                         value: ' ' === e[l - 2].type ? '*' : ''
                                       })).replace(z, '$1'),
  ...
  function kt(e, t, r, o) {
    ...
    if (!o && 1 === f.length) {
      if (((u = f[0] = f[0].slice(0)),
           u.length > 2 && 'ID' === (l = u[0]).type && n.getById &&
  ...
  (n.sortStable = v.split('').sort(S).join('') === v), (n.detectDuplicates = E),
      ...
      (n.attributes && ut(function(e) {
         return (
             (e.innerHTML = '<input/>'), e.firstChild.setAttribute('value', ''),
      ...
      (x.unique = ot.uniqueSort), (x.text = ot.getText),
...
(x.Callbacks =
    ...
    (x.support = (function(t) {
       ...
       return n.type ?
           ((n.type = 'checkbox'), (t.checkOn = '' !== n.value),
            (t.optSelected = a.selected), (t.reliableMarginRight = !0),
            (t.boxSizingReliable = !0), (t.pixelPosition = !1),
            (n.checked = !0), (t.noCloneChecked = n.cloneNode(!0).checked),
            (s.disabled = !0), (t.optDisabled = !a.disabled),
            (n = o.createElement('input')), (n.value = 't'), (n.type = 'radio'),
            (t.radioValue = 't' === n.value), n.setAttribute('checked', 't'),
...
x.extend({
  ...
  _queueHooks: function(e, t) {
    ...
    x.fn.extend({
      ...
      delay: function(e, t) {
        return (
            (e = x.fx ? x.fx.speeds[e] || e : e), (t = t || 'fx'),
          ...
          i || t.isDefaultPrevented() ||
              ...
              (c && x.isFunction(r[d]) && !x.isWindow(r) &&
               ((u = r[c]), u && (r[c] = null), (x.event.triggered = d), r[d](),
                (x.event.triggered = undefined), u && (r[c] = u))),
          t.result);
    }
  },
  dispatch: function(e) {
...
x.fn.extend({
  ...
  index: function(e) {
    return e ?
        'string' == typeof e ? g.call(x(e), this[0]) :
                               g.call(this, e.jquery ? e[0] : e) :
        this[0] && this[0].parentNode ? this.first().prevAll().length : -1;
  },
  add: function(e, t) {
    var n =
        'string' == typeof e ? x(e, t) : x.makeArray(e && e.nodeType ? [e] : e),
      ...
      clone: function(e, t, n) {
        ...
        if (t)
          if (n)
            ...
            gt(e, a);
        return (
            (s = mt(a, 'script')), s.length > 0 && dt(s, !u && mt(e, 'script')),
            a);
      },
...
var vt, xt, bt = /^(none|table(?!-c[ea]).+)/, wt = /^margin/,
            Tt = RegExp('^(' + b + ')(.*)$', 'i'),
                   ...
                   null == n || ('number' === o && isNaN(n)) ||
                       ('number' !== o || x.cssNumber[a] || (n += 'px'),
                        x.support.clearCloneStyle || '' !== n ||
                            0 !== t.indexOf('background') || (u[t] = 'inherit'),
                        (s && 'set' in s &&
  ...
  serializeArray: function() {
    return this
        ...
        .filter(function() {
          var e = this.type;
          return (
              this.name && !x(this).is(':disabled') && zt.test(this.nodeName) &&
           ...
           s.length > 0 &&
               x.ajax({url: e, type: i, dataType: 'html', data: t})
                   .done(function(e) {
                     (o = arguments),
                         s.html(
                             r ? x('<div>').append(x.parseHTML(e)).find(r) : e);
                   })
                   .complete(
                       n &&
                       function(e, t) {
        ...
        send: function(n, r) {
          ...
          (t =
               function(e) {
                 return function() {
                   t &&
                       (delete vn[o], (t = s.onload = s.onerror = null),
                        'abort' === e ?
                            s.abort() :
                            'error' === e ?
...
function jn(e, t, n) {
  var r, i,
      o = 0, s = kn.length, a = x.Deferred().always(function() {
        delete u.elem;
      }),
      u =
          function() {
  ...
  for (Dn(c, l.opts.specialEasing); s > o; o++)
    if ((r = kn[o].call(l, e, c, l.opts)))
      return r;
  return (
      x.map(c, Sn, l), x.isFunction(l.opts.start) && l.opts.start.call(e, l),
...
x.each(
    ...
    (x.fn.offset =
         function(e) {
           ...
           var t, n, i = this[0], o = {top: 0, left: 0},
                     s = i && i.ownerDocument;
           if (s)
             return (
                 (t = s.documentElement),
