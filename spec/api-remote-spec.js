...
describe("remote module", () => {
  ...
  describe("remote.require", () => {
    ...
    it("should work when object has no prototype", () => {
      const a = remote.require(
        path.join(fixtures, "module", "no-prototype.js")
      );
    ...
    it("should work with function properties", () => {
      ...
      a = remote
        .require(
          path.join(fixtures, "module", "function-with-missing-properties.js")
        )
        .setup();
    ...
    it("should work with static class members", () => {
      const a = remote.require(
        path.join(fixtures, "module", "remote-static.js")
      );
  ...
  describe("remote object in renderer", () => {
    it("can change its properties", () => {
      const property = remote.require(
        path.join(fixtures, "module", "property.js")
      );
      ...
      const property2 = remote.require(
        path.join(fixtures, "module", "property.js")
      );
    ...
    it("rethrows errors getting/setting properties", () => {
      const foo = remote.require(
        path.join(fixtures, "module", "error-properties.js")
      );
    ...
    it("can set a remote property with a remote object", () => {
      const foo = remote.require(
        path.join(fixtures, "module", "remote-object-set.js")
      );
    ...
    it("can reassign and delete its member functions", () => {
      const remoteFunctions = remote.require(
        path.join(fixtures, "module", "function.js")
      );
  ...
  describe("remote promise", () => {
    it("can be used as promise in each side", (done) => {
      const promise = remote.require(
        path.join(fixtures, "module", "promise.js")
      );
    ...
    it("handles rejections via catch(onRejected)", (done) => {
      const promise = remote.require(
        path.join(fixtures, "module", "rejected-promise.js")
      );
    ...
    it("handles rejections via then(onFulfilled, onRejected)", (done) => {
      ...
      promise.reject(Promise.resolve(1234)).then(
        () => {},
        (error) => {
          assert.equal(error.message, "rejected");
          done();
