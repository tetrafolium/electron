...
if (guestInstanceId != null) {
  guestInstanceId = parseInt(guestInstanceId);
  if (openerId != null) {
    openerId = parseInt(openerId);

    require('../renderer/window-setup')(
        ipcRenderer, guestInstanceId, openerId, hiddenPage, nativeWindowOpen);
  }
}
