...
// This helps us avoid Chromium's various optimizations so we can ensure
// renderer process is restarted everytime.
var NavigationController = (function() {
  function NavigationController(webContents) {
    ...
    this.webContents.on(
        'navigation-entry-commited', (event, url, inPage, replaceEntry) => {
