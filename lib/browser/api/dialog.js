...
module.exports = {
  showOpenDialog: function(...args) {
    ...
    const wrappedCallback =
        typeof callback === 'function' ? function(success, result) {
  ...
  showMessageBox: function(...args) {
    ...
    return binding.showMessageBox(
        messageBoxType, buttons, defaultId, cancelId, flags, title, message,
        detail, checkboxLabel, checkboxChecked, icon, window, callback);
  },
  ...
  showCertificateTrustDialog: function(...args) {
    ...
    return binding.showCertificateTrustDialog(
        window, certificate, message, callback);
  },
};
