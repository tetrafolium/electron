...
BrowserWindow.prototype._init =
    ...
    const options =
        {
          ...
          webContents: webContents
            ...
            .emit(
                'ELECTRON_GUEST_WINDOW_MANAGER_INTERNAL_WINDOW_OPEN', event,
                url, frameName, disposition, options)
  })
  ...
  this.webContents.on('activate', () => {
    if (process.platform !== 'darwin' && this.isMenuBarAutoHide() &&
    ...
    const visibilityChanged = () => {
      ...
      if (isVisible !== newState) {
        ...
        const visibilityState = isVisible ?
            'visible' :
            'hidden' this.webContents.emit(
                '-window-visibility-change', visibilityState)
      }
    }
  }
                    ...
                    (webContents) => {
                      for (const window of BrowserWindow.getAllWindows()) {
                        ...
                        if (devToolsWebContents != null &&
                            devToolsWebContents.equal(webContents)) {
                          return window
                        }
                      }
                    }
                                     ...
                                     Object.assign(BrowserWindow.prototype, {
                                       ...
                                       openDevTools(...args) {
                                         return this.webContents.openDevTools(
                                             ...args)
                                       },
                                       closeDevTools() {
                                       ...
                                       inspectElement(...args) {
                                         return this.webContents.inspectElement(
                                             ...args)
                                       },
                                       ...
                                       setTouchBar(touchBar) {
                                         electron.TouchBar._setOnWindow(
                                             touchBar, this)
                                       }
                                     })
